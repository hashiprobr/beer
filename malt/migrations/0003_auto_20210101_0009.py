...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='draftcalendar',
            constraint=models.CheckConstraint(check=models.Q(begin_date__lte=django.db.models.expressions.F('end_date')), name='draft_calendar_dates_order'),
        ),
        migrations.AlterUniqueTogether(
            name='draftcalendar',
